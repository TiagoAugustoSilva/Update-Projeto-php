                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link active" href="index.php">
                            <h5 class="text-light"> Cadastrar Produtos</h5>
                        </a>
                    </li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="card mt-4">
                ...
                <div class="card-body bg-dark m-3">
                    <h2 class="text-center mb-4 text-white">Movimentações</h2>
                    <!-- Botão +Adicionar -->
                    <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#adicionarModal">
                        +Adicionar
                    </button>

                    <a class="btn btn-danger mb-3" href="index.php">Voltar</a>
